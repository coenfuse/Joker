...
// ACCOUNT_STATs => 0: ENABLE, 1: DISABLE, 2: MONITOR, 3: BLOCK

std::map<std::string, std::string> NET100_data = {
	{"BID001","BID:'BID001', TYPE:'ADM', IS_ACTIVE:'T', ONLINE:'T', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'120', NET:'NET100', OWN:'T', AID:'vilidutt', NAME:'Villi Dutt Jr.', GUARDIAN:'Villi Dutt', DOB:'02/NOV/2001', GENDER:'M', PH1:'CODE:(91), NUM:(7892561425)', PH2:'CODE:(91), NUM:(9982998175)', EM1:'HEAD:(villionly), HOST:(gmail.com)', EM2:'HEAD:(villiduttjr), HOST:(outlook.com)', ADD1:'HNO:(6015), BLO:NULL, COL:NULL, LAN:(Troy Drive), AREA:NULL, CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T'"},
	{"BID002","BID:'BID002', TYPE:'ADM', IS_ACTIVE:'T', ONLINE:'F', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'148', NET:'NET100', OWN:'F', AID:'armelo', NAME:'Amara Konzuke', GUARDIAN:'Noriyuki Haga', DOB:'26/MAR/1996', GENDER:'M', PH1:'CODE:(91), NUM:(8452365789)', PH2:'CODE:(91), NUM:(9236785165)', EM1:'HEAD:(amara), HOST:(gmail.com)', EM2:'HEAD:(smallpox), HOST:(outlook.com)', ADD1:'HNO:(6), BLO:(J), COL:NULL, LAN:(Turnip County), AREA:NULL, CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T'"},
	{"BID003","BID:'BID003', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'2', PROFILE_COMPLETE:'F', LOG_COUNT:'173', NET:'NET100', OWN:'F', AID:'armanza', NET:'NET100', OWN:'0', NAME:'Arman Mullick', GUARDIAN:'Javedd Mullick', DOB:'01/OCT/1995', GENDER:'O', PH1:'CODE:(1), NUM:(3041301994)', PH2:'CODE:(7), NUM:(8791838379)', EM1:'HEAD:(armanmullick), HOST:(china.com.cn)', EM2:'HEAD:(armanmere), HOST:(vistaprint.com)', ADD1:'HNO:(5), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Birchwood Plaza), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T'"},
	{"BID004","BID:'BID004', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'2', PROFILE_COMPLETE:'F', LOG_COUNT:'469', NET:'NET100', OWN:'F', AID:'zakajuda', NET:'NET100', OWN:'0', NAME:'Maddy Waddilove', GUARDIAN:'Taffy Waddilove', DOB:'06/OCT/1994', GENDER:'F', PH1:'CODE:(63), NUM:(9828788939)', PH2:'CODE:(86), NUM:(3343061642)', EM1:'HEAD:(twaddilove2), HOST:(slideshare.com)', EM2:'HEAD:(twaddilove2), HOST:(flickr.com)', ADD1:'HNO:(422), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Redwing Parkway), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T'"},
	{"BID005","BID:'BID005', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'879', NET:'NET100', OWN:'F', AID:'coenfuse', NET:'NET100', OWN:'0', NAME:'Fonken Bhattacharya', GUARDIAN:'Swami Miheer Bhattacharya', DOB:'08/FEB/2002', GENDER:'M', PH1:'CODE:(91), NUM:(9717268459)', PH2:'CODE:(91), NUM:(9548627179)', EM1:'HEAD:(coenfuse), HOST:(gmail.com)', EM2:'HEAD:(sarthak), HOST:(coenfuse.com)', ADD1:'HNO:(8), BLO:NULL, COL:NULL, LAN:(Caliangt Trail), AREA:NULL, CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'F', ADD2:'HNO:(8429), BLO:NULL, COL:NULL, LAN:(Menomonie Parkway), AREA:(Menomonie), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL'"},
	{"BID006","BID:'BID006', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'915', NET:'NET100', OWN:'F', AID:'larochey', NET:'NET100', OWN:'0', NAME:'Rouvin Copcote', GUARDIAN:'Scott Cahillane', DOB:'11/DEC/1998', GENDER:'M', PH1:'CODE:(33), NUM:(9194897873)', PH2:'CODE:(33), NUM:(5515762856)', EM1:'HEAD:(rouvin), HOST:(gmail.com)', EM2:'HEAD:(danydaniel), HOST:(joomla.com)', ADD1:'HNO:(274), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Northview Pass), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T'"},
	{"BID007","BID:'BID007', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'065', NET:'NET100', OWN:'F', SID:'2017-310-123', NET:'NET100', PEN:'0', NAME:'Sarthak Sharma', GUARDIAN:'Om Prakash Sharma', DOB:'11/FEB/1999', GENDER:'M', PH1:'CODE:(91), NUM:(8153338479)', PH2:'CODE:(91), NUM:(8606157348)', EM1:'HEAD:(supp), HOST:(gmail.com)', EM2:'HEAD:(contactherebitch), HOST:(outlook.com)', ADD1:'HNO:(16), BLO:(H), COL:(Depression), LAN:(FICCI), AREA:(Manhoos Corner), CIT:(New Delhi), STA:(Delhi), COU:(India), PIN:(110001)', ADD2==ADD1:'T', DEPT:'Research and Development'"},
	{"BID008","BID:'BID008', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'012', NET:'NET100', OWN:'F', SID:'2017-310-124', NET:'NET100', PEN:'0', NAME:'Etana Forsaith', GUARDIAN:'Rodrique Raecroft', DOB:'16/APR/1994', GENDER:'F', PH1:'CODE:(218), NUM:(7176456431)', PH2:'CODE:(62), NUM:(6397959326)', EM1:'HEAD:(rraecroft0), HOST:(cpanel.net)', EM2:'HEAD:(rraecroft), HOST:(fotki.com)', ADD1:'HNO:(325), BLO:(A), COL:(Green), LAN:(Ridge Alley), AREA:NULL, CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T', DEPT:'SEST'"},
	{"BID009","BID:'BID009', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'546', NET:'NET100', OWN:'F', SID:'2017-310-125', NET:'NET100', PEN:'0', NAME:'Frasquito Fermor', GUARDIAN:'Nero Petracchi', DOB:'31/July/1997', GENDER:'M', PH1:'CODE:(86), NUM:(6538189636)', PH2:'CODE:(351), NUM:(4119350694)', EM1:'HEAD:(npetracchi5), HOST:(yellowbook.com)', EM2:'HEAD:(npetracchi5), HOST:(w3.org)', ADD1:'HNO:(700), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Lerdahl Terrace), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T', DEPT:'Sales'"},
	{"BID010","BID:'BID010', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'125', NET:'NET100', OWN:'F', SID:'2017-310-126', NET:'NET100', PEN:'0', NAME:'Madlin Sher', GUARDIAN:'Tami Bennike', DOB:'24/06/1994', GENDER:'O', PH1:'CODE:(62), NUM:(2786623479)', PH2:'CODE:(264), NUM:(7163064480)', EM1:'HEAD:(tbennike6), HOST:(ihg.com)', EM2:'HEAD:(tbennike6), HOST:(google.com)', ADD1:'HNO:(8), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Homewood Trail), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T', DEPT:'R&D'"},
	{"BID011","BID:'BID011', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'2', PROFILE_COMPLETE:'F', LOG_COUNT:'885', NET:'NET100', OWN:'F', SID:'2017-310-127', NET:'NET100', PEN:'0', NAME:'Chickie Bich', GUARDIAN:'Elliot Mendez', DOB:'01/JAN/2000', GENDER:'M', PH1:'CODE:(86), NUM:(9341870602)', PH2:'CODE:(351), NUM:(1322259622)', EM1:'HEAD:(emendez7), HOST:(themeforest.net)', EM2:'HEAD:(emendez7), HOST:(wordpress.com)', ADD1:'HNO:(5959), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Florence Trail), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'T', DEPT:'Business Development'"},
	{"BID012","BID:'BID012', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'985', NET:'NET100', OWN:'F', SID:'2017-310-128', NET:'NET100', PEN:'0', NAME:'Daffi Gillis', GUARDIAN:'Bettina Menloe', DOB:'11/JUN/1992', GENDER:'F', PH1:'CODE:(86), NUM:(5665103641)', PH2:'CODE:(62), NUM:(3333234866)', EM1:'HEAD:(bmenloe8), HOST:(live.com)', EM2:'HEAD:(bmenloe8), HOST:(surveymonkey.com)', ADD1:'HNO:(700), BLO:(C), COL:NULL, LAN:NULL, AREA:(Dotti Junction), CIT:NUL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'F', ADD2:'HNO:(3), BLO:(P), COL:NULL, LAN:NULL, AREA:(West Trail), CIT:NUL, STA:NULL, COU:NULL, PIN:NULL', DEPT:'SEST'"},
	{"BID013","BID:'BID013', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'354', NET:'NET100', OWN:'F', SID:'2017-310-129', NET:'NET100', PEN:'0', NAME:'Katheryn Calderonello', GUARDIAN:'Ronny Schonfelder', DOB:'20/OCT/1993', GENDER:'F', PH1:'CODE:(62), NUM:(4352248349)', PH2:'CODE:(1), NUM:(4144350867)', EM1:'HEAD:(rschonfelder9), HOST:(kickstarter.com)', EM2:'HEAD:(rschonfelder9), HOST:(digg.com)', ADD1:'HNO:(43), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Meadow Valley Point), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'F', ADD2:'HNO:(486), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Prairieview Road), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', DEPT:'Legal'"},
	{"BID014","BID:'BID014', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'3', PROFILE_COMPLETE:'F', LOG_COUNT:'756', NET:'NET100', OWN:'F', SID:'2017-310-130', NET:'NET100', PEN:'0', NAME:'Dennison Heino', GUARDIAN:'Jdavie Endicott', DOB:'29/DEC/1999', GENDER:'F', PH1:'CODE:(86), NUM:(8587682677)', PH2:'CODE:(7), NUM:(4532248349)', EM1:'HEAD:(jendicotta), HOST:(linkedin.com)', EM2:'HEAD:(jendicotta), HOST:(reddif.com)', ADD1:'HNO:(9), BLO:NULL, COL:NULL, LAN:NULL, AREA:(Glendale Point), CIT:NULL, STA:NULL, COU:(India), PIN:(110001)', ADD2==ADD1:'T', DEPT:'Services'"},
	{"BID015","BID:'BID015', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'0', PROFILE_COMPLETE:'F', LOG_COUNT:'526', NET:'NET100', OWN:'F', SID:'2017-310-131', NET:'NET100', PEN:'0', NAME:'Christy Libbe', GUARDIAN:'Ivy Crichten', DOB:'30/JUN/1993', GENDER:'O', PH1:'CODE:(86), NUM:(8455390685)', PH2:'CODE:(1), NUM:(8822298534)', EM1:'HEAD:(icrichtenb), HOST:(169.com)', EM2:'HEAD:(icrichtenb), HOST:(myelin.com)', ADD1:'HNO:(9), BLO:(G), COL:NULL, LAN:(Holmberg Avenue), AREA:NULL, CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'F', ADD2:'HNO:(57), BLO:(H), COL:NULL, LAN:(Green Ridge Drive), AREA:NULL, CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', DEPT:'Legal'"},
	{"BID016","BID:'BID016', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'685', NET:'NET100', OWN:'F', SID:'2017-310-132', NET:'NET100', PEN:'0', NAME:'Owen Goldston', GUARDIAN:'Saleem Longford', DOB:'14/JAN/1994', GENDER:'M', PH1:'CODE:(972), NUM:(9477757029)', PH2:'CODE:(86), NUM:(2114977381)', EM1:'HEAD:(slongfordc), HOST:(digg.com)', EM2:'HEAD:(slongfordc), HOST:(woothemes.com)', ADD1:'HNO:(51775), BLO:(S), COL:(Buena Vista Park), LAN:NULL, AREA:NULL, CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', ADD2==ADD1:'F', ADD2:'HNO:(245), BLO:(H), COL:NULL, LAN:NULL, AREA:(Lillian Hill), CIT:NULL, STA:NULL, COU:NULL, PIN:NULL', DEPT:'Sales'"},
};
std::map<std::string, std::string> NET200_data = {
	{"BID001","BID:'BID001', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'685', NET:'NET200', OWN:'T', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID002","BID:'BID002', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID003","BID:'BID003', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID004","BID:'BID004', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID005","BID:'BID005', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID006","BID:'BID006', TYPE:'ADM', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID007","BID:'BID007', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID008","BID:'BID008', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID009","BID:'BID009', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID010","BID:'BID010', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID011","BID:'BID011', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID012","BID:'BID012', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID013","BID:'BID013', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID014","BID:'BID014', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID015","BID:'BID015', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'F', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"},
	{"BID016","BID:'BID016', TYPE:'STU', IS_ACTIVE:'F', ONLINE:'T', ACCOUNT_STAT:'1', PROFILE_COMPLETE:'F', LOG_COUNT:'245', NET:'NET200', OWN:'F', AID:'', NET:'NET200', OWN:'1', NAME:'', GUARDIAN:'', DOB:'', GENDER:'', ACT_STAT:'', PH1:'CODE:(), NUM:()', PH2:'CODE:(), NUM:()', EM1:'HEAD:(), HOST:()', EM2:'HEAD:(), HOST:()', ADD1:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', ADD2==ADD1:'0', ADD2:'HNO:(), BLO:(), COL:(), LAN:(), AREA:(), CIT:(), STA:(), COU:(), PIN:()', DEPT:''"}
};
